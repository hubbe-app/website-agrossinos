...
export default function WhoWeAre() {
  ...
  const contentTwo =
    'Tem como premissa de sua atuação estar mais próximas de seus parceiros e clientes, além de conectar produtores e compradores, nossa equipe compartilha conhecimento e informação, seja sobre tendências de mercado, sazonalidade ou estratégias de negociação.';
